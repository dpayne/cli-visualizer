...
int main()
{
    ...
    for ( auto i = 255; i >= 0; --i)
    {
        ...
        m_writer.write_background(1, 255 - i,
                  to_ansi_color(red, green, blue),
                  msg);
    }
    ...
    {
        m_writer.write_background(2, i,
                  m_writer.to_color_rainbow(i, 256),
                  msg);
    }

    for ( auto i = 0; i < 256; ++i)
    {
        m_writer.write_background(3, i,
                  i,
                  msg);
    }
      getch();
