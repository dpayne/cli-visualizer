...
vis::SgsTransformer::SgsTransformer(const Settings *const settings)
    : SpectrumTransformer(settings)
{
}

vis::SgsTransformer::~SgsTransformer()
{
}

void vis::SgsTransformer::draw(int32_t win_height, int32_t win_width,
                               bool flipped, vis::NcursesWriter *writer)
{
    ...
    auto smoothed_bar_heights = smooth_sgs(bar_heights);
...
int32_t vis::SgsTransformer::normalize_height(const int32_t win_height,
 ...
 */
std::vector<double>
vis::SgsTransformer::smooth_sgs(const std::vector<double> &frequencies)
{
